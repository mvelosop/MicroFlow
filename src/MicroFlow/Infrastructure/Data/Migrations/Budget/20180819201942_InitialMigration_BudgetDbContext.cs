    ...
    public partial class InitialMigration_BudgetDbContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BudgetClass = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LapseCount = table.Column<int>(nullable: true),
                    LapseUnit = table.Column<int>(nullable: true),
                    OccurrenceCount = table.Column<int>(nullable: true),
                    OnDay = table.Column<int>(nullable: true),
                    OnEndOfMonth = table.Column<bool>(nullable: true),
                    OnMonth = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
